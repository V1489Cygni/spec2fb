...
public class ConsecutiveAntColonyFactory<Instance extends Constructable<Instance>, MutationType extends InstanceMutation<Instance>> extends AntColonyFactory<Instance, MutationType> {
	@Override
	public AntColony<Instance, MutationType> createAntColony(SearchGraph<Instance, MutationType> graph,
		...
		return new ConsecutiveAntColony<Instance, MutationType>(graph, startNodes, antFactory, stats, task, antStagnationParameter);
	}
}
